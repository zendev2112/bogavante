                ...
                <div className="p-5">
                  <div className="flex flex-wrap gap-1 mb-3">
                    {(nota as any).category && (
                      <span className="tag-navy uppercase">
                        {NOTAS_CATEGORIES.find(c => c.value === (nota as any).category)?.label || (nota as any).category}
                      </span>
                    )}
                  </div>
                  <h3 className="font-playfair font-bold text-lg text-[#1F2937] mb-2 line-clamp-2">
                ...
                <div className="p-5">
                  <div className="flex flex-wrap gap-1 mb-3">
                    {(articulo as any).category && (
                      <span className="tag-teal uppercase">
                        {SALUD_CATEGORIES.find(c => c.value === (articulo as any).category)?.label || (articulo as any).category}
                      </span>
                    )}
                  </div>
                  <h3 className="font-playfair font-bold text-lg text-[#1F2937] mb-2 line-clamp-2">
